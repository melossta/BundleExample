...
namespace BundleExampleStep2\Migration;
 ...
 * @internal
 */
class Migration1753084245 extends MigrationStep
{
    ...
    private function createBundleTranslationTable(Connection $connection): void
    {
        ...
        CREATE TABLE IF NOT EXISTS `swag_bundle_translation` (
            ...
            CONSTRAINT `fk.bundle_translation.bundle_id` 
                FOREIGN KEY (`swag_bundle_id`) 
                REFERENCES `swag_bundle` (`id`) 
                ON DELETE CASCADE ON UPDATE CASCADE,
            CONSTRAINT `fk.bundle_translation.language_id` 
    ...
    private function createBundleProductTable(Connection $connection): void
    {
        ...
        CREATE TABLE IF NOT EXISTS `swag_bundle_product` (
            ...
            CONSTRAINT `fk.bundle_product.bundle_id` FOREIGN KEY (`bundle_id`) REFERENCES `swag_bundle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
            CONSTRAINT `fk.bundle_product.product_id__product_version_id` FOREIGN KEY (`product_id`, `product_version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
    ');
    }
